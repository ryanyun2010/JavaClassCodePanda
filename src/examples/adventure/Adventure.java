...
public class Adventure extends Game {
    ...
    public Adventure() {
        ...
        foodShop.addTransitions(hotel,airport,pandaZoo,pool,bambooForest,hospital);
        hospital.addTransitions(hotel,airport,pandaZoo,pool,bambooForest,foodShop);
        bambooForest.addTransitions(hotel,airport,pandaZoo,pool,hospital,foodShop);
        pool.addTransitions(hotel,airport,pandaZoo,bambooForest,foodShop,hospital);
